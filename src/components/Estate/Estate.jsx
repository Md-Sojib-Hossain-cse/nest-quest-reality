...
const Estate = ({ estateData }) => {
    ...
    return (
        <div className="grid md:grid-cols-5 lg:grid-cols-1 xl:grid-cols-5 justify-between gap-6 bg-[#13131344] shadow-lg drop-shadow-lg p-4 rounded-lg">
            <div id="imgDiv" className="relative col-span-3 w-full">
                <img src={image} alt="property image unavailable" className="w-full h-full object-cover rounded-lg"/>
            ...
            <div className="md:col-span-2 lg:col-span-1 xl:col-span-2">
                ...
                <button className="btn text-lg shadow-lg font-bold">{button_text}</button>
            </div>
        </div>
    );
};
